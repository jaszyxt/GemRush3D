...
namespace UnityEditor.Rendering.PostProcessing
{
    ...
    public sealed class ProfileFactory
    {
        ...
        static void CreatePostProcessProfile()
        {
            ...
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(default, ScriptableObject.CreateInstance<DoCreatePostProcessProfile>(), "New Post-processing Profile.asset", null, null);
        }
    ...
    // Unity 6 removed EndNameEditAction; AssetCreationEndAction has the
    // same Action(int, string, string) override.
